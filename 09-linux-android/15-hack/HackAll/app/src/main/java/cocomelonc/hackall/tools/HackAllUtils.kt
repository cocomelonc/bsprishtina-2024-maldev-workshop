    ...
    companion object {
        ...
        fun isWelcomePageEnable(context: Context): Boolean {
            return if (getHackAllData(context).welcomeTitle.trim() == "") {
                false
            } else context.getSharedPreferences("hackprefs", Context.MODE_PRIVATE)
                .getBoolean("isWelcomeEnable", true)
        }

        fun disableWelcome(context: Context) {
            val prefs = context.getSharedPreferences("hackprefs", Context.MODE_PRIVATE)
        ...
        fun getHackAllData(context: Context): HackAllData {
        ...
        fun getHackAllNetworkData(context: Context): HackAllNetworkData {
            val assets = context.assets
